...
class UtilitaireTest {
    ...
    void testReformatageChaineDat() {
        ...
        Assertions.assertEquals("Je NEAR suis NEAR {WITHIN} NEAR content".toUpperCase(), Utilitaire.formatString("Je AND suis! within content"));
        Assertions.assertEquals("Je NEAR suis NEAR {WITHIN} NEAR content".toUpperCase(), Utilitaire.formatString("Je AND suis! 'WITHIN' content"));
        Assertions.assertEquals("J NEAR y NEAR suis NEAR {WITHIN} NEAR content".toUpperCase(), Utilitaire.formatString("J'y AND suis! 'WITHIN' content"));
        Assertions.assertEquals("J NEAR y NEAR suis NEAR {WITHIN} NEAR CONTENT NEAR THÉ".toUpperCase(), Utilitaire.formatString("J'y AND suis! 'WITHIN' content a yours the thé"));
    }
}
